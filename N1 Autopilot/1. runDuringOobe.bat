...
powershell -Command "Start-Process PowerShell -ArgumentList '-ExecutionPolicy Bypass -File ""%~dp0\Device Profiling\listSt&Mac&SdSn.ps1""' -Verb RunAs -WindowStyle Hidden"